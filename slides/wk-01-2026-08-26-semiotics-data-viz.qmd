...
<!-- ::: {#fig-simulation-of-pluto-collision} -->
...
>Cassirer argues that the classic Aristotelian definition of the human being as a rational animal is wrong, or at least incomplete. Instead we should think of ourselves as “symbolic animals,” since ratiocination^[The process of exact thinking. <https://www.merriam-webster.com/dictionary/ratiocination>] is only one expression of the human instinct to think in symbols. @Kirsch2021-fd
...
:::
::: {.column width=50%}
![Famous Jedi Knight from Star Wars, Yoda is.](../include/img/yoda-failure-teacher.jpg){#fig-yoda width="75%"}
:::
::::
