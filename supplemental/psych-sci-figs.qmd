...
This page extracts information about the data visualizations we explored in [Exercise-01](../exercises/ex-01-figs-in-psych-sci.qmd) from the shared Google Sheet.

## Survey

Direct link: <https://docs.google.com/spreadsheets/d/1Q9xYmkvXsETfTHZjGXWxQ3vM2TBVWWo3Jimfv1Bkvfw/edit?gid=0#gid=0>

<iframe src="https://docs.google.com/spreadsheets/d/1Q9xYmkvXsETfTHZjGXWxQ3vM2TBVWWo3Jimfv1Bkvfw/edit?gid=0#gid=0 width="640" height="800" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
...
r_functions <- list.files(file.path(here::here(), "R"), "\\.R$", full.names = TRUE)
...
if (params$update_data) {
  ...
  googledrive::drive_download(
    "PSYCH-490.007-2026-Fall-Psych-Viz",
...
There were *n*=`{r} length(unique(ex01$identifier))` unique respondents.

Of the `{r} dim(ex01)[1]` responses from these individuals or teams, *n*=`{r} dim(figs_w_urls)[1]` had URLs we could link to directly.
