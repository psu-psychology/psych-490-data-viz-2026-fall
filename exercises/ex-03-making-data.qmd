...
Submit write-up for credit [due]{.orange_due} by ~~[Friday, September 25, 2026](../schedule.qmd#fri-sep-25)~~ [Friday, October 2, 2026](../schedule.qmd#fri-oct-02).
...
![Blank form button](../include/img/google-forms-blank-form.png){#fig-google-form-blank-form width="50%"}
3. Give your form a useful title, for example, 'PSYCH-490.007-2026-spring-team-A' or 'PSYCH-490.007-2026-spring-rog1'.
...
![Google Forms 'Send'](../include/img/google-forms-send-button.png){#fig-google-forms-send width="50%"}
...
![Add collaborators](../include/img/google-forms-add-collaborators.png){#fig-add-collaborators width="50%"}
