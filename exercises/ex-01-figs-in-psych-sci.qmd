...
[Canvas dropbox](https://psu.instructure.com/courses/2484925/assignments/18448425).
...
<https://docs.google.com/spreadsheets/d/1Q9xYmkvXsETfTHZjGXWxQ3vM2TBVWWo3Jimfv1Bkvfw/edit?usp=sharing>
...
- A 5 paragraph (introduction, 3-paragraph body, conclusion) write-up.
  - You may use your favorite Word processing program (e.g., Microsoft Word or Google Docs), OR
  - You may use the Quarto [template](ex-01-template.qmd) 
- Describe three (3) figures your group found, focusing on these questions:
...
4. If you use the Quarto template to generate the final document, the best submissions will adhere to the structure of the APA paper format for the *Commentary* section.
  
::: {.callout-important}
## American Psychological Association (APA) template

This [template](https://docs.google.com/document/d/1cv_MjQVKnGc9sbaYiOUna2155jMEvUxACwyDax-XYWI/edit?tab=t.0) document  may be helpful.
:::
