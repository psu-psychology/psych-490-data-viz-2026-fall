...
Due on ~~[Friday, September 11](../schedule.qmd#fri-sep-11)~~ [Friday, September 25, 2026](../schedule.qmd#fri-sep-26). 
...
<https://docs.google.com/spreadsheets/d/1bTMuWopvUz8M1OHQU5mnMvWXvBMb3tj2sLFLGXHzviI/edit?usp=sharing>
...
- A commentary where you describe three (3) figures your group found, answering the questions in 4. above. As with Exercise 01, use write a complete five paragraph essay structure. APA document format is *strongly* recommended.
- If you wish to submit a Quarto document (worth 3 extra credit points), adapt the Quarto [template](ex-01-template.qmd) for Exercise 01. Embed the figures using the template code sequences, e.g. `![Figure caption here](link_to_figure_here)`. If you use the Quarto template, you do *not* follow the APA formatting guidelines except for your reference section.
